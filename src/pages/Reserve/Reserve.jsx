        ...
        <div className="Reserve-container">
            <div className="Reserve-hut-info">
                ...
                <div className='Hut-info'>
                    ...
                    <p className='Hut-info-rooms'><b>Tipos de habitación:</b> apartamento de 4 cuartos y 3 baños. Cocina último modelo y mucha agua</p>
                    <p className='Hut-info-location'><b>Tipo de locación:</b> Océano aventurero</p>
                </div>
            </div>
